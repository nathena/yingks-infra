...
public class WxUserGateWay {
	...
	private static String wxuser_api = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=%s&openid=%s&lang=zh_CN";
	...
	public WxUserGateWay(String appid,String appSercet)
	{
	...
	{
		String api = String.format(wxuser_api, wxAccessTokenService.geWxAccessToken().getToken(),openId);
